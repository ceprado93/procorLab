            ...
            <SideDrawer isOpen={isCartOpen} onClose={closeCart} id="cart__page">
                <Container d="flex" flexDir="column" h="100%">
                    <Row justify="space-between" border={{ b: '1px solid' }} p="0.7rem" borderColor="gray300">
                        <Text tag="h1" textColor="black500" textSize="paragraph" hoverTextColor="black700" transition="0.3s">Carrito</Text>
                    ...
                    <Row flexGrow="2" p="0.7rem" overflow="auto" flexWrap="nowrap" flexDir="column">
                        {checkout.lineItems.length < 1 ?
                            <Row>
                                <Col><Text tag="h1" textColor="black500" textSize="paragraph" hoverTextColor="black700" transition="0.3s">El carrito está vacío</Text></Col>
                            </Row>
                            ...
                            <>
                                {checkout.lineItems && checkout.lineItems.map(item => (
                                    ...
                                    <Row key={item.id} p={{ t:"5px" }}>
                                        ...
                                        <Col>
                                            <Text  maxLength="11">{item.variant.price*item.quantity}€</Text>
                                        </Col>
                    ...
                    <Row border={{ t: '1px solid' }} p="0.7rem" borderColor="gray300">
                        <Anchor w="100%" href={checkout.webUrl} target="_blank" rel="noopener noreferrer">
                            <Button w="100%" rounded="0" bg="black500" shadow="2" className="hero_link" hoverShadow="3" m={{t: '1rem'}}>
                                FINALIZAR PEDIDO
                            </Button>
                        </Anchor>
                    </Row>
