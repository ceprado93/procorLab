        ...
        <div id="home-empresas">
            <div className="topnav" id="topnav">
                <div className="menu" >
                    ...
                    <div>
                        <a id="menu-empresa"><Link className="Nav__link" to="/procor-personas">IR A PERSONAS</Link></a>
                    </div>
                    <div id="myLinks" className="hamHome">
                        ...
                        <a onClick={handleClick}><Link className="Nav__link" to="/procor-personas">Ir a personas</Link></a>
            ...
            <section className="home" id="Homempresas">
                <div id="home__landing">
                    <div className="texto_home">
                        <p id="SemiBold">QUEREMOS <br></br>
                    AYUDARTE</p>
                        <p>Espacios de trabajo<br></br>
                         Covid free
                    </p>
            ...
            <section id="personas">
                <p id="SemiBold">ProcorLab<br></br>Empresas</p>
                <p>El servicio integral de prevención y diagnóstico de Covid-19 de ProcorLab te ayudará a generar confianza entre tus clientes y trabajadores a través de la creación de espacios COVID free.  <br></br>
                </p>
                <p>Te ofrecemos la oportunidad de cuidar de lo más importante; las personas. Nos ajustamos a tus necesidades; tamaño de la empresa, ubicación, presupuesto, etc. y ponemos
                a tu disposición un equipo de profesionales para la prevención y detección temprana de la enfermedad.
            ...
            <section id="test_cada_persona">
                <div>
                    <p id="SemiBold" className="bs">Tenemos un test para cada evento.<br></br>
                    Nos adaptamos a las necesidades de tu empresa.</p>
                ...
                <div>
                    <div className="boton--producto ">
                        <a className="hero_link_home"><Link className="descubre" onClick={scrollToSection} ><img src={pideMasInfo} /></Link></a>
                    </div>
                </div>
            </section>
            ...
            <section id="en_que_momento">
                <div>
                    <p id="SemiBold">Te escuchamos y te damos soluciones</p>
                    <div className="ayudarte">
                        <div id="filas">
                            <div className="izquierda">
                                <img src={asesoramiento} />
                                <p id="SemiBold">Asesoramiento</p>
                                <p>Un grupo de especialistas <br></br>
atenderá tus dudas. Conocemos lo <br></br>que realmente te importa.
                            ...
                            <div className="derecha">
                                ...
                                <p>Llegamos hasta donde tu <br></br>
...
nos desplazamos contigo.
                        ...
                        <div id="filas">
                            <div className="izquierda">
                                ...
                                <p>Trabajamos con el <br></br>
laboratorio de la Universidad <br>
                                    </br>Carlos III de Madrid.
</p>
                            </div>
                            <div className="derecha">
                                <img src={personalizacion} />
                                <p id="SemiBold">Personalización</p>
                                <p>Cada empresa tiene sus <br></br>
...
Solicita tu plan personalizado.
            ...
            <section id="ayudarte">
                <div>
                    <p id="SemiBold">Crea tus espacios Covid free</p>
                </div>
                <div id="filas" className="bs">
                    <div className="izquierda">
                        <img src={numero1} />
                        <p>No dejes de celebrar un evento o <br></br>
de realizar jornadas de networking<br></br> por razones sanitarias.</p>
                    </div>
                    <div className="derecha">
                        <img src={numero4} />
                        <p>Realizamos los test precisos y <br></br>
                ...
                <div id="filas" className="bs">
                    <div className="izquierda">
                        <img src={numero2} />
                        <p>ProcorLab te ofrece un servicio<br></br>
                        de prevención totalmente ajustados
                        <br></br> a tus necesidades.</p>
                    </div>
                    <div className="derecha">
                        <img src={numero5} />
                        <p>Posteriormente lanzamos un<br></br>informe personalizado a cada uno<br></br> de los asistentes.</p>
                    </div>
                </div>
                <div id="filas" className="bs">
                    <div className="izquierda">
                        <img src={numero3} />
                        <p>Nos trasladamos el día del evento <br></br>o jornada de trabajo hasta el lugar<br>
                        </br> de celebración.</p>
                    </div>
                    <div className="derecha">
                        <img src={numero6} />
                        <p>En caso de haber algún positivo<br></br>realizaremos un seguimiento del<br></br> caso y posibles contactos previos.</p>
                    </div>
                </div>
...
de realizar jornadas de networking<br></br> por razones sanitarias.</p>
                ...
                <div className="boton--producto ">
                    <a className="hero_link_home"><Link className="descubretest" onClick={scrollToSection} ><img src={descubreTest} /></Link></a>
                </div>
            </section>
                ...
                <section className="contact__form">
                    <form id="contact-form" onSubmit={sendEmail}>
                        ...
                        <div className=" botones botones--contacto">
                            <p><input type="checkbox" name="terms" requiered /> Acepto <u>la política de privacidad</u></p>
